  ...
  async function postnewPassword(e) {
    ...
    try {
      const response = await axios.put(
        "http://localhost:70000/reset/password/admin",
      ...
      if (
        response.data.message === "Email not found thus password not updated"
      ) {
        setLoading(false);
  ...
  return (
    <div className="container">
      <div className="reg">
        ...
        <strong>Update Password for admins</strong>
...
export default Resetpasswordadmins;
