    ...
    <div className="nav">
      ...
      <div className="categories">
        ...
        <ul style={{ display: isVisible ? "block" : "none" }}>
          <li>All Laptops ({alllaptopscounted})</li>
          <Link to="/hp/laptops" className="link">
            <li>HP Laptops ({noofHPlaptops})</li>
          </Link>
      ...
      {loading ? (
        ...
        <div className="filterpricewise">
          ...
          <div className="limits">
            <input
              type="number"
              placeholder="Enter lower price eg 0"
              onChange={(e) => setLowerlimitpricerange(e.target.value)}
            />{" "}
            to{" "}
            <input
              type="number"
              placeholder="Enter higher price eg 1000000"
              onChange={(e) => setHigherlimitprice(e.target.value)}
            />
            <i>
              <FcSearch onClick={filterLaptopsonpricerange} />
            </i>
            <p>{noresults}</p>
          </div>
